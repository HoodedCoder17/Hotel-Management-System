 ...
 * HibernateJpaAutoConfiguration.class }) public class DBConfig {
 * 
 ...
 * 
 * @Value("${spring.jpa.properties.hibernate.dialect}") public String dialect;
 * 
 * @Value("${spring.jpa.hibernate.ddl-auto}") public String ddl;
 * 
 ...
 * hibernateSessionFactory(DataSource dataSource) { LocalSessionFactoryBean
 * sessionFactory = new LocalSessionFactoryBean();
 * sessionFactory.setDataSource(dataSource());
 * sessionFactory.setPackagesToScan(new String[] { "com.hms.entities.*" });
 * sessionFactory.setHibernateProperties(hibernateProperties()); return
 * sessionFactory; }
 * 
 * @Bean HibernateTransactionManager transactionManagerHib(SessionFactory
 ...
 * em.setPackagesToScan("com.hms.entities.*");
